...
/**
 * @Description: miui indicator 切换三角型滑动效果
 * xml属性：zhy:item_count="3"默认加载Tab个数
 * indicator.setTabItemTitles(datas);
 * indicator.setViewPager(viewPager,0);
 * @Address: http://blog.csdn.net/lmj623565791/article/details/42160391
 */
public class MiUiViewPagerIndicator extends LinearLayout {
     ...
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFFFCE80B;
    ...
    public MiUiViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(Color.parseColor("#FCE80B"));
    ...
    protected void highLightTextView(int position) {
        ...
        if (view instanceof TextView) {
            ((TextView) view).setTextColor(Color.parseColor("#FCE80B"));
        }
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onTitleClick != null) {
                        if (j == 0 && mViewPager.getCurrentItem() == 0) {
                            onTitleClick.onTitleCallBack(j);
                        }
                    }
    ...
    public void setOnTitleClick(MiUiViewPagerIndicator.onTitleClick onTitleClick) {
        this.onTitleClick = onTitleClick;
    }

    public interface onTitleClick {
        void onTitleCallBack(int position);
    }
